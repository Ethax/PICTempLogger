...
;Serial.c,15 :: 		void Serial_initialize(enum BaudRate baudrate) {
;Serial.c,18 :: 		switch(baudrate) {
	GOTO        L_Serial_initialize0
;Serial.c,19 :: 		case BAUD_1200:
L_Serial_initialize2:
;Serial.c,20 :: 		UART1_Init(1200); break;
	BSF         BAUDCON+0, 3, 0
	MOVLW       6
	MOVWF       SPBRGH+0 
	MOVLW       130
...
;Serial.c,21 :: 		case BAUD_2400:
L_Serial_initialize3:
;Serial.c,22 :: 		UART1_Init(2400); break;
	BSF         BAUDCON+0, 3, 0
	MOVLW       3
	MOVWF       SPBRGH+0 
	MOVLW       64
	...
	CALL        _UART1_Init+0, 0
	GOTO        L_Serial_initialize1
;Serial.c,23 :: 		case BAUD_4800:
L_Serial_initialize4:
;Serial.c,24 :: 		UART1_Init(4800); break;
	BSF         BAUDCON+0, 3, 0
	MOVLW       1
	MOVWF       SPBRGH+0 
	MOVLW       160
	...
	CALL        _UART1_Init+0, 0
	GOTO        L_Serial_initialize1
;Serial.c,25 :: 		case BAUD_9600:
L_Serial_initialize5:
;Serial.c,26 :: 		UART1_Init(9600); break;
	BSF         BAUDCON+0, 3, 0
	CLRF        SPBRGH+0 
	MOVLW       207
	MOVWF       SPBRG+0 
	...
	CALL        _UART1_Init+0, 0
	GOTO        L_Serial_initialize1
;Serial.c,27 :: 		case BAUD_19200:
L_Serial_initialize6:
;Serial.c,28 :: 		UART1_Init(19200); break;
	BSF         BAUDCON+0, 3, 0
	CLRF        SPBRGH+0 
	MOVLW       103
	MOVWF       SPBRG+0 
	...
	CALL        _UART1_Init+0, 0
	GOTO        L_Serial_initialize1
;Serial.c,29 :: 		case BAUD_38400:
L_Serial_initialize7:
;Serial.c,30 :: 		UART1_Init(38400); break;
	BSF         BAUDCON+0, 3, 0
	CLRF        SPBRGH+0 
	MOVLW       51
	MOVWF       SPBRG+0 
	...
	CALL        _UART1_Init+0, 0
	GOTO        L_Serial_initialize1
;Serial.c,31 :: 		case BAUD_57600:
L_Serial_initialize8:
;Serial.c,32 :: 		UART1_Init(57600); break;
	BSF         BAUDCON+0, 3, 0
	CLRF        SPBRGH+0 
	MOVLW       34
	MOVWF       SPBRG+0 
	...
	CALL        _UART1_Init+0, 0
	GOTO        L_Serial_initialize1
;Serial.c,33 :: 		case BAUD_115200:
L_Serial_initialize9:
;Serial.c,34 :: 		UART1_Init(115200); break;
	BSF         BAUDCON+0, 3, 0
	CLRF        SPBRGH+0 
	MOVLW       16
	MOVWF       SPBRG+0 
...
;Serial.c,38 :: 		RC1IF_bit = false;
	BCF         RC1IF_bit+0, BitPos(RC1IF_bit+0) 
;Serial.c,39 :: 		RC1IE_bit = true;
...
;Serial.c,46 :: 		void Serial_handleInterrupt() {
;Serial.c,48 :: 		uint8_t next_byte = UART1_Read();
	CALL        _UART1_Read+0, 0
	MOVF        R0, 0 
	MOVWF       Serial_handleInterrupt_next_byte_L0+0 
;Serial.c,53 :: 		if(next_byte == '\n') {
	MOVF        R0, 0 
	XORLW       10
	BTFSS       STATUS+0, 2 
	GOTO        L_Serial_handleInterrupt10
;Serial.c,54 :: 		switch(receiveBuffer[0]) {
	GOTO        L_Serial_handleInterrupt11
;Serial.c,55 :: 		case 'T': /* Time Setting */
L_Serial_handleInterrupt13:
;Serial.c,56 :: 		Application_dispatchEvent(Serial_receivedTimeSettingEvent);
...
;Serial.c,58 :: 		case 'R': /* Threshold Setting */
L_Serial_handleInterrupt14:
;Serial.c,59 :: 		Application_dispatchEvent(Serial_receivedThresholdSettingEvent);
...
;Serial.c,60 :: 		break;
	GOTO        L_Serial_handleInterrupt12
;Serial.c,61 :: 		case 'L': /* Log Request */
L_Serial_handleInterrupt15:
;Serial.c,62 :: 		Application_dispatchEvent(Serial_receivedLogRequestEvent);
...
;Serial.c,81 :: 		void* Serial_getReceivedData() {
;Serial.c,82 :: 		return (void*)&receiveBuffer[1];
...
;Serial.c,88 :: 		void Serial_sendLogEntry(LogEntry* entry) {
;Serial.c,93 :: 		memcpy(transmitBuffer, entry, sizeof(LogEntry));
	...
	CALL        _memcpy+0, 0
;Serial.c,94 :: 		for(i = 0; i < sizeof(LogEntry); i++)
...
;Serial.c,95 :: 		UART1_Write(transmitBuffer[i]);
	MOVLW       _transmitBuffer+0
	MOVWF       FSR0 
	MOVLW       hi_addr(_transmitBuffer+0)
	MOVWF       FSR0H 
...
;Serial.c,105 :: 		void Serial_sendAcknowledgement() {
;Serial.c,107 :: 		UART1_Write('A'); UART1_Write('C'); UART1_Write('K');
	MOVLW       65
	MOVWF       FARG_UART1_Write_data_+0 
	CALL        _UART1_Write+0, 0
	MOVLW       67
